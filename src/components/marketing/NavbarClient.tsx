...
/**
 * The interactive half of the marketing navbar. `Navbar` is the server component
    ...
    >
      ...
      <header className="border-b border-white/10 bg-[#0A0A0B] text-white">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5">
          ...
          {/* Right actions (desktop) — one button once they're in */}
          <div className="hidden items-center gap-2 md:flex">
            {isLoggedIn ? (
              <Link
                href="/dashboard"
                className="inline-flex items-center gap-2 rounded-lg bg-[#F5124A] px-4 py-2 text-sm font-semibold text-white shadow-[0_0_30px_-8px_rgba(245,18,74,0.7)] transition-opacity hover:opacity-90"
              >
          ...
          <div className="border-t border-white/10 bg-[#0A0A0B] px-5 py-4 md:hidden">
            ...
            <div className="mt-3 flex flex-col gap-2 border-t border-white/10 pt-3">
              {isLoggedIn ? (
                <Link
                  href="/dashboard"
                  className="inline-flex items-center justify-center gap-2 rounded-lg bg-[#F5124A] px-4 py-2.5 text-center text-sm font-semibold text-white"
                >
                  <LayoutDashboard className="h-4 w-4" />
                  Dashboard
                </Link>
